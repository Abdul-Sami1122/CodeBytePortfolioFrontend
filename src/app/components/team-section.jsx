...
const teamMembers = [
  ...
  },
  {
    ...
    social: {
      ...
      twitter: "#",
      github: "#",
      email: "alina@codebit.com",
    },
    icon: Rocket, // Using Rocket as placeholder icon
...
export function TeamSection() {
  ...
  // Infinite Scroll ke liye data duplicate kiya (Kam se kam 6 items hone chahiye smooth loop ke liye)
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* --- INFINITE SLIDER CONTAINER (Hover to Pause Fixed) --- */}
        <div className="relative w-full overflow-hidden group">
          {/* Fade Edges (Mouse events disabled taake hover neeche card tak puhnche) */}
          ...
          {/* The Sliding Track */}
          {/* Maine 'animate-scroll' class add ki hai aur inline style se animation lagayi hai */}
          <div className="flex gap-8 w-max py-4 animate-scroll">
            {/* CSS Magic Here */}
            <style>{`
            /* Slide Animation */
            @keyframes scroll {
            ...
            /* PAUSE ON HOVER (Most Important Fix) */
            /* Jab 'group' (parent) pe hover ho, to 'animate-scroll' (child) ruk jaye */
...
// Reusable Premium Team Card
function TeamCard({ member }) {
  const Icon = member.icon;

  return (
    <div className="group relative w-[300px] md:w-[350px] flex-shrink-0 h-full">
      {/* Card Container */}
      <div className="relative h-full bg-white dark:bg-gray-900/40 dark:backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col">
        ...
        <div className="p-6 md:p-8 flex flex-col flex-grow relative">
          {/* Inner Glow on Hover */}
          <div
            className={`absolute inset-0 bg-gradient-to-br ${member.color} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-500 pointer-events-none`}
          />
          ...
          <div className="pt-6 border-t border-gray-100 dark:border-gray-800 relative z-10">
            <div className="flex flex-wrap gap-2 mb-4">
              {member.expertise.map((skill) => (
                <span
                  key={skill}
                  className="text-[10px] uppercase font-bold tracking-wider bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 px-2.5 py-1 rounded-md border border-gray-200 dark:border-white/5"
                >
                  {skill}
                </span>
              ))}
...
function StatCard({ number, label, color }) {
  return (
    <div className="bg-white dark:bg-gray-900/40 backdrop-blur-md border border-gray-100 dark:border-gray-800 p-6 rounded-2xl text-center shadow-sm hover:shadow-lg transition-all duration-300 group">
      <div
